...
[This project is in pause because I'll wait to have my homelab or a AWS/Google Cloud account. I have to vectorize some functions, build some tests and make a cleaner code. Since I started to do this with no AI because I wanted to learn more of the basics I wanted to have a break to pay attention to some bigger projects, as models for fraud detection]
